...
class inputFrame(tk.Frame):
	...
	def createWidget(self):
		self.vmInfo = tk.Label(self, text="Choose syslog path:(space char or Chinese NOT supported)", justify=tk.LEFT)
		...
		self.vmInfo = tk.Label(self, text="Choose Module:", justify=tk.LEFT)
	...
	def getOptions(self):
		return self.master.cfg.getModuleOptions()
...
class actFrame(tk.Frame):
	...
	def start(self):
		...
		checkDump.checkDump(realLogPath, realPlatform)

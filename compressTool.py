...
class extractFile:
	...
	def extractFile(self):
		if self.tool.valid == False:
			...
			name_noext, ext = os.path.splitext(self.fileNm)
			print self.tool.exe + self.tool.extractcmd.format(self.fileNm, name_noext)
			os.system(self.tool.exe + self.tool.extractcmd.format(self.fileNm, name_noext))
			return 0
